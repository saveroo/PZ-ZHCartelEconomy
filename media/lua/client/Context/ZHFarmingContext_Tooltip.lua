...
CustomTooltip = ISPanel:derive("CustomTooltip");
--************************************************************************--
--** CustomTooltip:initialise
--**
--************************************************************************--

function CustomTooltip:initialise()
    ISPanel.initialise(self);
end

function CustomTooltip:setItem(item)
    self.item = item;
end

function CustomTooltip:onMouseDown(x, y)
    return false
end

function CustomTooltip:onMouseUp(x, y)
    return false
end

function CustomTooltip:onMouseDownOutside(x, y)
    if self.followMouse then
        self:setVisible(false)
    end
end

function CustomTooltip:onRightMouseDown(x, y)
    return false
end

function CustomTooltip:onRightMouseUp(x, y)
    return false
end

--************************************************************************--
--** CustomTooltip:render
--**
--************************************************************************--

function CustomTooltip:prerender()
...
function CustomTooltip:adjustPositionToAvoidOverlap(avoidRect)
...
function CustomTooltip:placeAbove(r1, r2)
    local r = r1
    r.y = r2.y - r.height - 8
    r.y = math.max(0, r.y)
    return r
...
function CustomTooltip:setOwner(ui)
    self.owner = ui
end

function CustomTooltip:setCharacter(chr)
...
--**
--************************************************************************--
function CustomTooltip:new(item)
    local o = {}
